...
export class AwsS3Service {
    ...
    constructor() {
        this.s3Client = new S3Client({
            credentials: {
                accessKeyId:
                    configService.aws.credential.key as string,
                secretAccessKey: configService.aws.credential.secret as string
            },
            region: configService.aws.s3.region,
        });

        this.bucket = configService.aws.s3.bucket;
        this.baseUrl = configService.aws.s3.baseUrl;
    }
